...
export default function Page() {
  const [state, setState] = useState<LayoutDividerState>(DEFAULT_LAYOUTDIVIDER_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Layout Divider Studio" controls={controls} preview={output} /></AppShell>;
}

...
export default function Page() {
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Layout Divider Studio" headerActions={headerActions} controls={controls} preview={output} /></AppShell>;
}
